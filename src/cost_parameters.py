...
# ★★★ 全て仮置き — コンテスト課題 Ver.2.0 のサイト仕様に置き換えること ★★★
#
...
# 単位の取り決め:
#   電力     : 円/kWh
#   蒸気・燃料・冷水 : 円/GJ  （kW 連続消費を年換算: kW × 3.6e-3 × OP_HOURS = GJ/年）
...
# LP Steam 単価 [円/GJ]  ★ 160°C 6bar、3円/kg ÷ 2.087 MJ/kg ≒ 1437 円/GJ に余裕
LP_STEAM_JPY_PER_GJ: float = 1800.0

# 冷却水単価 [円/GJ]  ★ 0.04〜0.08 円/MJ の中央値
COOLING_WATER_JPY_PER_GJ: float = 60.0

# 燃料 (反応器プリヒーター LNG) 単価 [円/GJ]  ★ 50円/Nm³, HHV 40MJ/Nm³ ≒ 1250 円/GJ
FUEL_JPY_PER_GJ: float = 1500.0

# PtSn 触媒単価 [円/kg]  ★ 文献値範囲 3〜10 万円/kg の中央値 (Pt 含有率に依存)
CATALYST_PTSN_JPY_PER_KG: float = 50000.0

# PtSn 触媒寿命 [年]  ★ 通常 2〜5 年、コーキング・再生回数で変動
CATALYST_PTSN_LIFE_YEARS: float = 3.0
