...
def simulate_column2(
    ...
    design = DistDesignVars(
        ...
        # Dist2 は partial condenser (分流型)。塔頂に H2/CH4 が大量に来るため
        # total condenser だと T_cond が cryogenic になる。実機どおり H2/CH4 は
        # そのまま vapor distillate で抜き、残りの C2 だけを propylene 冷媒で
        # 凝縮して reflux する分流モデル。
